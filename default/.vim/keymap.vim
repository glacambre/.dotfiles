...
" TODO: Make this work without X and allow using other registers
" nnoremap y "+y
" nnoremap yy "+yy
...
nnoremap vv V
" V selects till the end of the line just like D deletes till the eol
nnoremap V v$h
...
nnoremap X :silent call WipeButKeepOpen(1)<CR>
...
" When the completion menu is shown, escape closes it but stays in insert mode.
inoremap <expr> <Esc> pumvisible() ? "\<C-E>" : "\<Esc>"
" Tab selects the next autocompletion item.
inoremap <expr> <Tab> pumvisible() ? "\<C-n>" : "\<C-g>u\<Tab>"
" Shift-Tab selects the previous autocompletion item.
...
" B goes to the beginning of the line (easier to reach than ^)
nnoremap B ^
